...
It's a straightfoward check that $$\| \dot{G} \subset \breve{mathbb{B}} \| = 1. 

$$\begin{align} \| x \in \dot{G} \land y \in \breve{\mathbb{B}} \land x \breve{\leq} y = \bigvee_{b, c \in \mathbb{B}} \|  \end{align}$$
