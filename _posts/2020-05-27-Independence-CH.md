...
For the proof sketched in the introduction, we don't just want a single new real, but a whole set. The notion of forcing $(P, \leq)$ in this case is the set of functions $$f : \omega_2 \times \omega \to \{0,1\}$$, partially ordered by inclusion as above. 
